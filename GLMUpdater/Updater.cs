...
namespace GLMUpdater
{
	class Updater
	{
		...
		private readonly string downloadURL = "https://github.com/T-RVSP/Stealth-Luma/releases/download/v{0}/Stealth.Luma.zip";
		...
		public async Task IsUpdated()
		{
			...
			if (currentVersion.CompareTo(latestVersion) < 0)
			{
				...
				foreach (Process process in Process.GetProcessesByName("Stealth Luma"))
				{
				...
				while (Process.GetProcessesByName("Stealth Luma").Length > 0)
				{
